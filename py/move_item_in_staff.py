...
from functions import checkExistTreeParents
...
try:
    ...
    staff_id = storage.getvalue('staff_id')
    target_staff_id = storage.getvalue('target_staff_id')
    ...
    if worker_id is not None and staff_id is not None and target_staff_id:
        ...
        if staff_id != 0:
            ...
            if str(parent_id_now) != str(target_staff_id):
